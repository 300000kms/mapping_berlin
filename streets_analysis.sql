create table streets_a as select st_length(geometry) length ,ST_NPoints(simplify(geometry, 10)) npoints, 
degrees(st_azimuth(startpoint(geometry), endpoint(geometry) ) ) angle, 
